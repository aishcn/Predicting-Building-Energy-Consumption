...
``` {r, echo=FALSE ,out.width="49%", out.height="20%",fig.cap="Spearman Correlation with Response",fig.show='hold',fig.align='center'}
...
``` {r, echo=FALSE ,out.width="49%", out.height="20%",fig.cap="Pairwise Correlation Analysis of Features",fig.show='hold',fig.align='center'}
...
### 4.0.1 Pipeline
``` {r, echo=FALSE ,out.width="49%", out.height="20%",fig.cap="Pipeline of Workflow",fig.show='hold',fig.align='center'}
...
```{r, echo=FALSE ,out.width="49%", out.height="20%",fig.cap="Variaple Importance Plots using Random Forest",fig.show='hold',fig.align='center'}
