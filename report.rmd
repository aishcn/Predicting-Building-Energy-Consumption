...
``` {r, echo=FALSE ,out.width="75%", out.height="75%",fig.cap="Spearman Correlation with Response",fig.show='hold',fig.align='center'}
...
## 3.3.2 Plots Investigating Relationships with Site EUI
``` {r, echo=FALSE ,out.width="49%", out.height="20%",fig.cap=" Plots Investigating Relationships with Site EUI",fig.show='hold',fig.align='center'}
...
``` {r, echo=FALSE ,out.width="75%", out.height="75%",fig.cap="Pairwise Correlation Analysis of Features",fig.show='hold',fig.align='center'}
...
```{r, echo=FALSE ,out.width="75%", out.height="75%",fig.cap="Pairwise Correlation Analysis After intial Feature Engineering",fig.show='hold',fig.align='center'}
...
```{r, echo=FALSE ,out.width="75%", out.height="75%",fig.cap="Feature Selectoin After Feature Engineering using Boruta Package Output",fig.show='hold',fig.align='center'}
